...
async function _fetchOrdersFromSupabase(){
  ...
  const r=await fetch(url,{headers:{'apikey':SB_KEY,'Authorization':'Bearer '+SB_KEY},signal:AbortSignal.timeout(8000)});
