(function () {
    ...
    const SpeechRecognition = registerPlugin('SpeechRecognition', {
        web: () => Promise.resolve().then(function () { return web$1; }).then((m) => new m.SpeechRecognitionWeb()),
    });
    ...
    window.CapacitorPlugins = window.CapacitorPlugins || {};
    window.Capacitor = window.Capacitor || {}; window.Capacitor.Plugins = window.Capacitor.Plugins || {}; if(!window.Capacitor.Plugins.SpeechRecognition) window.Capacitor.Plugins.SpeechRecognition = SpeechRecognition;
    if(!window.Capacitor.Plugins.NativeBiometric) window.Capacitor.Plugins.NativeBiometric = NativeBiometric;
    ...
    class NativeBiometricWeb extends WebPlugin {
        constructor() {
            super();
            /**
